Write-Output 'Testing has started...' -ForegroundColor Cyan
Start-Process -FilePath 'C:\Users\WDAGUtilityAccount\Desktop\master\Deploy-Application.exe' -Wait
Write-Output 'Installation completed' -ForegroundColor DarkGreen
Write-Output 'you have 60 seconds to verify the installation before it is automatically uninstalled' -ForegroundColor Cyan
...
Write-Output 'test completed' -ForegroundColor DarkGreen
Write-Output 'You can close sandbox now!' -ForegroundColor Cyan
